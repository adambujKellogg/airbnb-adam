...
SELECT listings.property_type, reviews.date_reviewed, COUNT(*) FROM reviews INNER JOIN listings on reviews.listing_id = listings.id GROUP BY listings.property_type;
-- +-------------------------------------+----------+----------------------------+
-- | Boat                                | 2        | 2021-06-19                 |
